...
Deadline für Abgabe per Pull Request: 03.11.2024 23:59 Uhr. Außerdem ist zusätzlich eine persönliche Abnahme in der von Ihnen belegten Übungsgruppe notwendig, um zu bestehen. Bei unentschuldigtem Fehlen in der auf die Deadline folgenden Übung, wird die Hausaufgabe als nicht bestanden bewertet. 

## Aufgabenstellung

- Forken Sie dieses Repository (github.com/prog2-ws24/ha1) in Ihren eigenen GitHub Account.
...
- **Commit: Teilaufgabe 1 - Grüner Test**
...
- **Commit: Teilaufgabe 2 - Erster roter Test + Teilaufgabe 2 - Zweiter Test rot**
...
- **Commit: Teilaufgabe 2 - Erster Test grün + Teilaufgabe 2 - Zweiter Test grün (Ich habe aus Versehen hier Teilaufgabe 2 geschrieben, obwohl es die dritte Aufgabe ist)**
